...
import GoldyBot
from GoldyBot.goldy.commands.slash_command import SlashCommand
#from GoldyBot.goldy.commands.group_command import GroupCommand
...
class Extension():
    ...
    def command(
        ...
        def decorate(func):
            def inner(func):
                goldy = GoldyBot.get_goldy_instance()
